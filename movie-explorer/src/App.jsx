...
export default function App() {
  ...
  // Fetch all initial shows from TVMaze API
  ...
  useEffect(() => {
    const handler = setTimeout(async () => {
      if (!searchQuery.trim()) {
        // If query is empty, revert to cached initial shows list
        if (allShowsBackup.length > 0) {
